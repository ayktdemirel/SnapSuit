...
Requests for refunds must be made to Apple at [reportaproblem.apple.com](https://reportaproblem.apple.com) — we have no ability to issue refunds for App Store purchases. Apple's decision is final. If Apple refunds a purchase, we may deduct the corresponding credits from your balance.
...
- upload only photographs of **yourself**, or of a person who has given you explicit permission
- use the generated portraits lawfully
...
- Generation may occasionally fail or produce unusable images.
- You are responsible for deciding whether a generated image is appropriate for the use you put it to, and for disclosing that it is AI-generated wherever that is required — for example by an employer, a professional body, or a platform's own rules.
